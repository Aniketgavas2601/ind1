...
final Size size = ui.window.physicalSize / ui.window.devicePixelRatio;
const animatedDuration = Duration(milliseconds: 500);

SizedBox verticalSpace({double? height}) {
  return SizedBox(height: height ?? ScreenConstant.size16);
}

SizedBox horizontalSpace({double? width}) {
  return SizedBox(width: width ?? ScreenConstant.size16);
}

Size? screenSize;
double defaultScreenWidth = 416.0;

double defaultScreenHeight = 897.0;
...
class ScreenConstant {
  ...
  static double size162 = 162;
  static double size166 = 166;
  ...
  static double size420 = 420;
  static double size455 = 455;
  static double size450 = 450;
  static double size460 = 460;

  /*Screen Size dependent Constants*/
  static double screenWidthFull = screenWidth;
  static double screenHeightFull = screenHeight;
  ...
  //static double screenHeightThreeAndhalf = screenHeight / 4.5;
  ...
  static void setScreenAwareConstant(context) {
    ...
    screenWidthFull = DeviceManager.instance.width;
    ...
    size18 = DeviceManager.instance.setWidth(18.0);
    ...
    size96 = DeviceManager.instance.setHeight(96.0);
    ...
    //size270 = DeviceManager.instance.setWidth(270);
    size280 = DeviceManager.instance.setWidth(280);
