                            ...
                            Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    CustomText(text: 'Insurance',color: Color(0xffFAFAFA),fontSize: FontSize.s16,fontWeight: FontWeight.w600,),
                                    // Stack(
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                                ...
                                                children: [
                                                  SizedBox(
                                                    //color: Colors.lightBlue,
                                                      ...
                                                      child: Text('Insure yourself & your loved ones',style: TextStyle(color: Color(0xffFFFFFF),fontSize: FontSize.s18,fontWeight: FontWeight.w500),)),
                                                  verticalSpace(height: ScreenConstant.size10),
                                              ...
                                              Row(
                                                children: [
                                                  SvgPicture.asset(ImagePath.insuranceLogo)
                                                ],
                                              ),
                                            ],
                                          ),
